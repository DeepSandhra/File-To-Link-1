...
<b>╰━━━━━━━〔𝙿𝙻𝙴𝙰𝚂𝙴 𝚂𝚄𝙿𝙿𝙾𝚁𝚃〕</b>""",
  parse_mode="html",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("⚡ sᴜᴘᴘᴏʀᴛ ⚡", url="https://t.me/+kZqIHs6RuU5lZTY1"), InlineKeyboardButton("ᴍᴏᴠɪᴇꜱ ᴄʜᴀɴɴᴇʟ 🎬", url="https://t.me/mdiskmovieshd_2022")],
                [InlineKeyboardButton("ᴍᴏᴠɪᴇꜱ ʙᴏᴛ ɢʀᴏᴜᴘ 🤖", url="https://t.me/+E_vuu_n6v5Q2YzA1")]
            ]
        )
    )
